...
**what determines the efficiency of a reversible heat engine**? First we note that

- the efficiency of any cycle performed by a reversible heat engine connecting two systems must be a
...
way as to violate the postulates.
- our case studies
...
The first system
is identical to the one considered
